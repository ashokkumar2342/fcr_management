...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <form name="usser_change_password" id="usser_change_password" toast-msg="true" action="{{ route('admin.user.change.password.store') }}"   class="add_form" method="post" autocomplete="off" >
                    {{ csrf_field()}}
